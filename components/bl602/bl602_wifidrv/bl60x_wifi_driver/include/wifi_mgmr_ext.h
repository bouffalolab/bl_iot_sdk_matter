...
typedef struct wifi_mgmr_network_config_adv {
    char pmk[66];
    uint8_t mac[6];
    uint16_t freq;
    uint8_t band;
    ...
    uint32_t dns2;
    uint8_t dhcp_use;
    long long ip_lease_time;
    long long timestamp;
    uint8_t gw_mac[6];
} wifi_mgmr_network_config_adv_t;
...
void wifi_mgmr_sta_connect_get_network_config(wifi_mgmr_network_config_adv_t *wifi_mgmr_network_conf);
