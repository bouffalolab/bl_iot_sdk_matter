...
typedef struct wifi_mgmr_api_network_config {
    uint32_t ip;
    uint32_t mask;
    uint32_t gw;
    uint32_t dns1;
    uint32_t dns2;
    uint8_t gw_mac[6];
} wifi_mgmr_api_network_config_t;

typedef struct wifi_mgmr_api_mac_config {
    uint8_t band;
    uint16_t freq;
    long long ip_lease_time;
    struct wifi_mgmr_api_network_config wifi_mgmr_ip_info;
    uint8_t dhcp_use;
} wifi_mgmr_api_mac_config_t;
