...
stddriver_sources := bl602_common.c bl602_uart.c bl602_dma.c bl602_glb.c bl602_timer.c bl602_ef_ctrl.c  \
					 ...
					 bl602_pds.c bl602_tzc_sec.c bl602_adc.c

ifeq ($(ROMAPI),y)
    stddriver_sources += bl602_romapi.c bl602_sflash_ext.c bl602_xip_sflash_ext.c bl602_sf_ctrl_ext.c bl602_sf_cfg_ext.c
	...
	stddriver_sources += bl602_sf_ctrl.c bl602_sflash.c bl602_sf_cfg.c  bl602_xip_sflash.c bl602_sflash_ext.c \
	 					 bl602_xip_sflash_ext.c bl602_sf_ctrl_ext.c
endif
