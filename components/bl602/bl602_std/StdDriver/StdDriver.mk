...
MODULE_DIR:= StdDriver
SUBMODULE_OUT_DIR:= $(TARGET_OUT_PATH)/StdDriver
...
stddriver_sources := bl602_common.c bl602_uart.c bl602_dma.c bl602_glb.c bl602_timer.c bl602_ef_ctrl.c  \
					 ...
					 bl602_pds.c bl602_tzc_sec.c 

ifeq ($(ROMAPI),y)
    stddriver_sources += bl602_romapi.c bl602_sflash_ext.c
    STDDRIVER_CFLAGS += -DBL602_USE_ROM_DRIVER
else
	stddriver_sources += bl602_sf_ctrl.c bl602_sflash.c bl602_sf_cfg.c  bl602_xip_sflash.c 
endif
