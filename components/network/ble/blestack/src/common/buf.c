...
extern struct net_buf_pool loopback_buf_pool;/* Added by bouffalo, buf poll for loopback */
struct net_buf_pool *_net_buf_pool_list[] = {&hci_cmd_pool, &hci_rx_pool, &acl_tx_pool, &adv_buf_pool, &loopback_buf_pool};
#else
