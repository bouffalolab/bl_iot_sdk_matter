...
#define BT_HCI_OP_LE_SET_WORK_MODE              BT_OP(BT_OGF_VS, 0x0061)
#define BT_HCI_LE_FULL_STACK_MODE               HCI_MODE_FULL_STACK
#define BT_HCI_LE_CONTROLLER_ONLY_MODE          HCI_MODE_CONTROLLER_ONLY
struct bt_hci_cp_le_set_set_work_mode {
    u8_t work_mode;
}__packed;
