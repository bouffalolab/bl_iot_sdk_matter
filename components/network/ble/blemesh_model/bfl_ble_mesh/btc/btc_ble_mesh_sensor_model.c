...
#include "bfl_ble_mesh_sensor_model_api.h"

/* Sensor Client Models related functions */

static inline void btc_ble_mesh_sensor_client_cb_to_app(bfl_ble_mesh_sensor_client_cb_event_t event,
        bfl_ble_mesh_sensor_client_cb_param_t *param)
{
    bfl_ble_mesh_sensor_client_cb_t btc_ble_mesh_cb =
        (bfl_ble_mesh_sensor_client_cb_t)btc_profile_cb_get(BTC_PID_SENSOR_CLIENT);
    if (btc_ble_mesh_cb) {
...
void btc_ble_mesh_sensor_client_arg_deep_copy(btc_msg_t *msg, void *p_dest, void *p_src)
{
    ...
    case BTC_BLE_MESH_ACT_SENSOR_CLIENT_GET_STATE: {
        dst->sensor_client_get_state.params = (bfl_ble_mesh_client_common_param_t *)bt_mesh_malloc(sizeof(bfl_ble_mesh_client_common_param_t));
        dst->sensor_client_get_state.get_state = (bfl_ble_mesh_sensor_client_get_state_t *)bt_mesh_malloc(sizeof(bfl_ble_mesh_sensor_client_get_state_t));
        if (dst->sensor_client_get_state.params && dst->sensor_client_get_state.get_state) {
            ...
            memcpy(dst->sensor_client_get_state.get_state, src->sensor_client_get_state.get_state,
                   sizeof(bfl_ble_mesh_sensor_client_get_state_t));

            switch (src->sensor_client_get_state.params->opcode) {
            case BFL_BLE_MESH_MODEL_OP_SENSOR_COLUMN_GET:
                ...
                break;
            case BFL_BLE_MESH_MODEL_OP_SENSOR_SERIES_GET:
    ...
    case BTC_BLE_MESH_ACT_SENSOR_CLIENT_SET_STATE: {
        dst->sensor_client_set_state.params = (bfl_ble_mesh_client_common_param_t *)bt_mesh_malloc(sizeof(bfl_ble_mesh_client_common_param_t));
        dst->sensor_client_set_state.set_state = (bfl_ble_mesh_sensor_client_set_state_t *)bt_mesh_malloc(sizeof(bfl_ble_mesh_sensor_client_set_state_t));
        if (dst->sensor_client_set_state.params && dst->sensor_client_set_state.set_state) {
            ...
            memcpy(dst->sensor_client_set_state.set_state, src->sensor_client_set_state.set_state,
                   sizeof(bfl_ble_mesh_sensor_client_set_state_t));

            switch (src->sensor_client_set_state.params->opcode) {
            case BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET:
                ...
                break;
            case BFL_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET:
...
{
    bfl_ble_mesh_sensor_client_cb_param_t *p_dest_data = (bfl_ble_mesh_sensor_client_cb_param_t *)p_dest;
    bfl_ble_mesh_sensor_client_cb_param_t *p_src_data = (bfl_ble_mesh_sensor_client_cb_param_t *)p_src;
    u16_t length = 0U;
    ...
    switch (msg->act) {
    case BFL_BLE_MESH_SENSOR_CLIENT_GET_STATE_EVT:
    case BFL_BLE_MESH_SENSOR_CLIENT_SET_STATE_EVT:
    case BFL_BLE_MESH_SENSOR_CLIENT_PUBLISH_EVT:
        if (p_src_data->params) {
            switch (p_src_data->params->opcode) {
            case BFL_BLE_MESH_MODEL_OP_SENSOR_DESCRIPTOR_GET:
            case BFL_BLE_MESH_MODEL_OP_SENSOR_DESCRIPTOR_STATUS:
                ...
                break;
            case BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_GET:
            case BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET:
            case BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_STATUS:
                ...
                break;
            case BFL_BLE_MESH_MODEL_OP_SENSOR_SETTINGS_GET:
            case BFL_BLE_MESH_MODEL_OP_SENSOR_SETTINGS_STATUS:
                ...
                break;
            case BFL_BLE_MESH_MODEL_OP_SENSOR_SETTING_GET:
            case BFL_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET:
            case BFL_BLE_MESH_MODEL_OP_SENSOR_SETTING_STATUS:
                ...
                break;
            case BFL_BLE_MESH_MODEL_OP_SENSOR_GET:
            case BFL_BLE_MESH_MODEL_OP_SENSOR_STATUS:
                ...
                break;
            case BFL_BLE_MESH_MODEL_OP_SENSOR_COLUMN_GET:
            case BFL_BLE_MESH_MODEL_OP_SENSOR_COLUMN_STATUS:
                ...
                break;
            case BFL_BLE_MESH_MODEL_OP_SENSOR_SERIES_GET:
            case BFL_BLE_MESH_MODEL_OP_SENSOR_SERIES_STATUS:
    ...
    case BFL_BLE_MESH_SENSOR_CLIENT_TIMEOUT_EVT:
        break;
    default:
        break;
    }
...
{
    bfl_ble_mesh_sensor_client_cb_param_t *arg = NULL;
    ...
    arg = (bfl_ble_mesh_sensor_client_cb_param_t *)(msg->arg);
...
#endif
static void btc_ble_mesh_sensor_client_callback(bfl_ble_mesh_sensor_client_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(&msg, cb_params,
                         sizeof(bfl_ble_mesh_sensor_client_cb_param_t), NULL);
}
...
{
    bfl_ble_mesh_sensor_client_cb_param_t cb_params = {0};
    ...
    case BTC_BLE_MESH_EVT_SENSOR_CLIENT_GET_STATE:
        act = BFL_BLE_MESH_SENSOR_CLIENT_GET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_SENSOR_CLIENT_SET_STATE:
        act = BFL_BLE_MESH_SENSOR_CLIENT_SET_STATE_EVT;
        break;
    case BTC_BLE_MESH_EVT_SENSOR_CLIENT_PUBLISH:
        act = BFL_BLE_MESH_SENSOR_CLIENT_PUBLISH_EVT;
        break;
    case BTC_BLE_MESH_EVT_SENSOR_CLIENT_TIMEOUT:
        act = BFL_BLE_MESH_SENSOR_CLIENT_TIMEOUT_EVT;
        break;
    default:
...
void btc_ble_mesh_sensor_client_call_handler(btc_msg_t *msg)
{
    ...
    btc_ble_mesh_sensor_client_args_t *arg = NULL;
    bfl_ble_mesh_sensor_client_cb_param_t cb = {0};
    ...
    case BTC_BLE_MESH_ACT_SENSOR_CLIENT_GET_STATE: {
        ...
        if (cb.error_code) {
            ...
            btc_ble_mesh_sensor_client_callback(&cb, BFL_BLE_MESH_SENSOR_CLIENT_GET_STATE_EVT);
        }
        break;
    }
    case BTC_BLE_MESH_ACT_SENSOR_CLIENT_SET_STATE: {
        ...
        if (cb.error_code) {
            /* If send failed, callback error_code to app layer immediately */
            btc_ble_mesh_sensor_client_callback(&cb, BFL_BLE_MESH_SENSOR_CLIENT_SET_STATE_EVT);
        }
        break;
    }
    default:
...
{
    bfl_ble_mesh_sensor_client_cb_param_t *param = NULL;
    ...
    param = (bfl_ble_mesh_sensor_client_cb_param_t *)(msg->arg);

    if (msg->act < BFL_BLE_MESH_SENSOR_CLIENT_EVT_MAX) {
...
static inline void btc_ble_mesh_sensor_server_cb_to_app(
    bfl_ble_mesh_sensor_server_cb_event_t event,
    bfl_ble_mesh_sensor_server_cb_param_t *param)
{
    bfl_ble_mesh_sensor_server_cb_t btc_ble_mesh_cb =
        (bfl_ble_mesh_sensor_server_cb_t)btc_profile_cb_get(BTC_PID_SENSOR_SERVER);
    if (btc_ble_mesh_cb) {
        btc_ble_mesh_cb(event, param);
    }
}
...
{
    bfl_ble_mesh_sensor_server_cb_param_t *p_dest_data = (bfl_ble_mesh_sensor_server_cb_param_t *)p_dest;
    bfl_ble_mesh_sensor_server_cb_param_t *p_src_data = (bfl_ble_mesh_sensor_server_cb_param_t *)p_src;
    u16_t length = 0U;
    ...
    switch (msg->act) {
    case BFL_BLE_MESH_SENSOR_SERVER_STATE_CHANGE_EVT:
        if (p_src_data->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET ||
                p_src_data->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET_UNACK) {
        ...
        } else if (p_src_data->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET ||
                   p_src_data->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET_UNACK) {
        ...
        break;
    case BFL_BLE_MESH_SENSOR_SERVER_RECV_GET_MSG_EVT:
        if (p_src_data->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_COLUMN_GET) {
        ...
        } else if (p_src_data->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_SERIES_GET) {
        ...
        break;
    case BFL_BLE_MESH_SENSOR_SERVER_RECV_SET_MSG_EVT:
        if (p_src_data->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET ||
                p_src_data->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET_UNACK) {
...
{
    bfl_ble_mesh_sensor_server_cb_param_t *arg = NULL;
    ...
    arg = (bfl_ble_mesh_sensor_server_cb_param_t *)(msg->arg);

    switch (msg->act) {
    case BFL_BLE_MESH_SENSOR_SERVER_STATE_CHANGE_EVT:
        if (arg->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET ||
                arg->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET_UNACK) {
        ...
        } else if (arg->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET ||
                   arg->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET_UNACK) {
            bt_mesh_free_buf(arg->value.state_change.sensor_setting_set.setting_value);
        }
        break;
    case BFL_BLE_MESH_SENSOR_SERVER_RECV_GET_MSG_EVT:
        if (arg->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_COLUMN_GET) {
            bt_mesh_free_buf(arg->value.get.sensor_column.raw_value_x);
        } else if (arg->ctx.recv_op == BFL_BLE_MESH_MODEL_OP_SENSOR_SERIES_GET) {
...
#endif
static void btc_ble_mesh_sensor_server_callback(bfl_ble_mesh_sensor_server_cb_param_t *cb_params, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    btc_transfer_context(
        &msg, cb_params, sizeof(bfl_ble_mesh_sensor_server_cb_param_t), NULL);
}
...
void bt_mesh_sensor_server_cb_evt_to_btc(u8_t evt_type,
        ...
        const u8_t *val, size_t len)
{
    bfl_ble_mesh_sensor_server_cb_param_t cb_params = {0};
    size_t length = 0U;
    uint8_t act = 0U;
    ...
    case BTC_BLE_MESH_EVT_SENSOR_SERVER_STATE_CHANGE:
        act = BFL_BLE_MESH_SENSOR_SERVER_STATE_CHANGE_EVT;
        break;
    case BTC_BLE_MESH_EVT_SENSOR_SERVER_RECV_GET_MSG:
        act = BFL_BLE_MESH_SENSOR_SERVER_RECV_GET_MSG_EVT;
        break;
    case BTC_BLE_MESH_EVT_SENSOR_SERVER_RECV_SET_MSG:
        act = BFL_BLE_MESH_SENSOR_SERVER_RECV_SET_MSG_EVT;
        break;
    default:
...
{
    bfl_ble_mesh_sensor_server_cb_param_t *param = NULL;
    ...
    param = (bfl_ble_mesh_sensor_server_cb_param_t *)(msg->arg);

    if (msg->act < BFL_BLE_MESH_SENSOR_SERVER_EVT_MAX) {
