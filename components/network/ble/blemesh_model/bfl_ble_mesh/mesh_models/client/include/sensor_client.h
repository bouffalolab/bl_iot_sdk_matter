...
#define BLE_MESH_MODEL_SENSOR_CLI(cli_pub, cli_data)    \
        BLE_MESH_MODEL(BT_MESH_MODEL_ID_SENSOR_CLI,    \
 ...
 */
int bt_mesh_sensor_cli_init(struct bt_mesh_model *model);
 ...
 * @return Zero-success, other-fail
 */
int bt_mesh_sensor_cli_deinit(struct bt_mesh_model *model);
