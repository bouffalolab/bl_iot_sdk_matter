...
int bt_mesh_time_cli_init(struct bt_mesh_model *model)
{
    model->op = time_cli_op;
    return time_scene_client_init(model);
}

int bt_mesh_scene_cli_init(struct bt_mesh_model *model)
{
    model->op = scene_cli_op;
    return time_scene_client_init(model);
}

int bt_mesh_scheduler_cli_init(struct bt_mesh_model *model)
{
    model->op = scheduler_cli_op;
    return time_scene_client_init(model);
}
...
int bt_mesh_time_cli_deinit(struct bt_mesh_model *model)
{
    return time_scene_client_deinit(model);
}

int bt_mesh_scene_cli_deinit(struct bt_mesh_model *model)
{
    return time_scene_client_deinit(model);
}

int bt_mesh_scheduler_cli_deinit(struct bt_mesh_model *model)
{
    return time_scene_client_deinit(model);
}
...
const struct bt_mesh_model_cb bt_mesh_scene_cli_cb = {
	.init = bt_mesh_scene_cli_init,
};

const struct bt_mesh_model_cb bt_mesh_scheduler_cli_cb = {
	.init = bt_mesh_scheduler_cli_init,
};