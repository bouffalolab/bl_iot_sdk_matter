...
#ifndef _BFL_BLE_MESH_SENSOR_MODEL_API_H_
#define _BFL_BLE_MESH_SENSOR_MODEL_API_H_
 ...
 */
#define BFL_BLE_MESH_MODEL_SENSOR_CLI(cli_pub, cli_data)            \
        BT_MESH_MODEL_CB(BFL_BLE_MESH_MODEL_ID_SENSOR_CLI,    \
...
} bfl_ble_mesh_sensor_column_get_t;
...
} bfl_ble_mesh_sensor_series_get_t;

/**
 * @brief Sensor Client Model get message union
 */
typedef union {
    bfl_ble_mesh_sensor_descriptor_get_t descriptor_get;    /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_DESCRIPTOR_GET */
    bfl_ble_mesh_sensor_cadence_get_t    cadence_get;       /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_GET */
    bfl_ble_mesh_sensor_settings_get_t   settings_get;      /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_SETTINGS_GET */
    bfl_ble_mesh_sensor_setting_get_t    setting_get;       /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_SETTING_GET */
    bfl_ble_mesh_sensor_get_t            sensor_get;        /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_GET */
    bfl_ble_mesh_sensor_column_get_t     column_get;        /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_COLUMN_GET */
    bfl_ble_mesh_sensor_series_get_t     series_get;        /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_SERIES_GET */
} bfl_ble_mesh_sensor_client_get_state_t;

/**
 * @brief Sensor Client Model set message union
 */
typedef union {
    bfl_ble_mesh_sensor_cadence_set_t cadence_set;          /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET & BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_SET_UNACK */
    bfl_ble_mesh_sensor_setting_set_t setting_set;          /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET & BFL_BLE_MESH_MODEL_OP_SENSOR_SETTING_SET_UNACK */
} bfl_ble_mesh_sensor_client_set_state_t;
...
} bfl_ble_mesh_sensor_descriptor_status_cb_t;
...
} bfl_ble_mesh_sensor_cadence_status_cb_t;
...
} bfl_ble_mesh_sensor_settings_status_cb_t;
...
} bfl_ble_mesh_sensor_column_status_cb_t;

/** Parameters of Sensor Series Status */
typedef struct {
    uint16_t property_id;  /*!< Property identifying a sensor and the Y axis  */
    struct net_buf_simple *sensor_series_value; /*!< Left values of sensor series status */
} bfl_ble_mesh_sensor_series_status_cb_t;

/**
 * @brief Sensor Client Model received message union
 */
typedef union {
    bfl_ble_mesh_sensor_descriptor_status_cb_t descriptor_status;   /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_DESCRIPTOR_STATUS */
    bfl_ble_mesh_sensor_cadence_status_cb_t    cadence_status;      /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_CADENCE_STATUS */
    bfl_ble_mesh_sensor_settings_status_cb_t   settings_status;     /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_SETTINGS_STATUS */
    bfl_ble_mesh_sensor_setting_status_cb_t    setting_status;      /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_SETTING_STATUS */
    bfl_ble_mesh_sensor_status_cb_t            sensor_status;       /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_STATUS */
    bfl_ble_mesh_sensor_column_status_cb_t     column_status;       /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_COLUMN_STATUS */
    bfl_ble_mesh_sensor_series_status_cb_t     series_status;       /*!< For BFL_BLE_MESH_MODEL_OP_SENSOR_SERIES_STATUS */
} bfl_ble_mesh_sensor_client_status_cb_t;
...
typedef struct {
    ...
    bfl_ble_mesh_sensor_client_status_cb_t status_cb;   /*!< The sensor status message callback values */
} bfl_ble_mesh_sensor_client_cb_param_t;

/** This enum value is the event of Sensor Client Model */
typedef enum {
    BFL_BLE_MESH_SENSOR_CLIENT_GET_STATE_EVT,
    BFL_BLE_MESH_SENSOR_CLIENT_SET_STATE_EVT,
    BFL_BLE_MESH_SENSOR_CLIENT_PUBLISH_EVT,
    BFL_BLE_MESH_SENSOR_CLIENT_TIMEOUT_EVT,
    BFL_BLE_MESH_SENSOR_CLIENT_EVT_MAX,
} bfl_ble_mesh_sensor_client_cb_event_t;
 ...
 */
typedef void (* bfl_ble_mesh_sensor_client_cb_t)(bfl_ble_mesh_sensor_client_cb_event_t event,
        bfl_ble_mesh_sensor_client_cb_param_t *param);
 ...
 *
 */
bfl_err_t bfl_ble_mesh_register_sensor_client_callback(bfl_ble_mesh_sensor_client_cb_t callback);
 ...
 *              please refer to bfl_ble_mesh_sensor_message_opcode_t in bfl_ble_mesh_defs.h
 *
 ...
 *
 */
bfl_err_t bfl_ble_mesh_sensor_client_get_state(bfl_ble_mesh_client_common_param_t *params,
        bfl_ble_mesh_sensor_client_get_state_t *get_state);
...
/** @def    BFL_BLE_MESH_MODEL_SENSOR_SRV
 *
 ...
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_sensor_srv_t.
 *
 *  @return New Sensor Server Model instance.
 */
#define BFL_BLE_MESH_MODEL_SENSOR_SRV(srv_pub, srv_data)             \
        BT_MESH_MODEL_CB(BFL_BLE_MESH_MODEL_ID_SENSOR_SRV,     \
                    NULL, srv_pub, srv_data, &bt_mesh_sensor_srv_cb)

/** @def    BFL_BLE_MESH_MODEL_SENSOR_SETUP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_sensor_setup_srv_t.
 *
 *  @return New Sensor Setup Server Model instance.
 */
#define BFL_BLE_MESH_MODEL_SENSOR_SETUP_SRV(srv_pub, srv_data)             \
        BT_MESH_MODEL_CB(BFL_BLE_MESH_MODEL_ID_SENSOR_SETUP_SRV,     \
                    NULL, srv_pub, srv_data, &bt_mesh_sensor_setup_srv_cb)

#define BFL_BLE_MESH_INVALID_SENSOR_PROPERTY_ID 0x0000  /*!< Invalid Sensor Property ID */

#define BFL_BLE_MESH_SENSOR_PROPERTY_ID_LEN     0x02    /*!< Length of Sensor Property ID */

#define BFL_BLE_MESH_SENSOR_DESCRIPTOR_LEN      0x08    /*!< Length of Sensor Descriptor state */

#define BFL_BLE_MESH_SENSOR_UNSPECIFIED_POS_TOLERANCE   0x000   /*!< Unspecified Sensor Positive Tolerance */
#define BFL_BLE_MESH_SENSOR_UNSPECIFIED_NEG_TOLERANCE   0x000   /*!< Unspecified Sensor Negative Tolerance */

#define BFL_BLE_MESH_SENSOR_NOT_APPL_MEASURE_PERIOD     0x00    /*!< Not applicable Sensor Measurement Period */

#define BFL_BLE_MESH_SENSOR_NOT_APPL_UPDATE_INTERVAL    0x00    /*!< Not applicable Sensor Update Interval */

#define BFL_BLE_MESH_INVALID_SENSOR_SETTING_PROPERTY_ID 0x0000  /*!< Invalid Sensor Setting Property ID */

#define BFL_BLE_MESH_SENSOR_SETTING_PROPERTY_ID_LEN     0x02    /*!< Length of Sensor Setting Property ID */
#define BFL_BLE_MESH_SENSOR_SETTING_ACCESS_LEN          0x01    /*!< Length of Sensor Setting Access */

#define BFL_BLE_MESH_SENSOR_SETTING_ACCESS_READ         0x01    /*!< Sensor Setting Access - Read */
#define BFL_BLE_MESH_SENSOR_SETTING_ACCESS_READ_WRITE   0x03    /*!< Sensor Setting Access - Read & Write */

#define BFL_BLE_MESH_SENSOR_DIVISOR_TRIGGER_TYPE_LEN    0x01    /*!< Length of Sensor Divisor Trigger Type */
#define BFL_BLE_MESH_SENSOR_STATUS_MIN_INTERVAL_LEN     0x01    /*!< Length of Sensor Status Min Interval */

#define BFL_BLE_MESH_SENSOR_PERIOD_DIVISOR_MAX_VALUE    15  /*!< Maximum value of Sensor Period Divisor */

#define BFL_BLE_MESH_SENSOR_STATUS_MIN_INTERVAL_MAX     26  /*!< Maximum value of Sensor Status Min Interval */

/**
 * Sensor Status Trigger Type - Format Type of the characteristic
 * that the Sensor Property ID state references
 */
#define BFL_BLE_MESH_SENSOR_STATUS_TRIGGER_TYPE_CHAR    0
/** Sensor Status Trigger Type - Format Type "uint16" */
#define BFL_BLE_MESH_SENSOR_STATUS_TRIGGER_TYPE_UINT16  1

#define BFL_BLE_MESH_SENSOR_DATA_FORMAT_A   0x00    /*!< Sensor Data Format A */
#define BFL_BLE_MESH_SENSOR_DATA_FORMAT_B   0x01    /*!< Sensor Data Format B */

#define BFL_BLE_MESH_SENSOR_DATA_FORMAT_A_MPID_LEN  0x02    /*!< MPID length of Sensor Data Format A */
#define BFL_BLE_MESH_SENSOR_DATA_FORMAT_B_MPID_LEN  0x03    /*!< MPID length of Sensor Data Format B */
 ...
 * of zero.
 */
#define BFL_BLE_MESH_SENSOR_DATA_ZERO_LEN   0x7F

/** @def    BFL_BLE_MESH_GET_SENSOR_DATA_FORMAT
 *
 ...
 */
#define BFL_BLE_MESH_GET_SENSOR_DATA_FORMAT(_data)      (((_data)[0]) & BIT_MASK(1))

/** @def    BFL_BLE_MESH_GET_SENSOR_DATA_LENGTH
 *
 ...
 */
#define BFL_BLE_MESH_GET_SENSOR_DATA_LENGTH(_data, _fmt)    \
            (((_fmt) == BFL_BLE_MESH_SENSOR_DATA_FORMAT_A) ? ((((_data)[0]) >> 1) & BIT_MASK(4)) : ((((_data)[0]) >> 1) & BIT_MASK(7)))

/** @def    BFL_BLE_MESH_GET_SENSOR_DATA_PROPERTY_ID
 *
 ...
 */
#define BFL_BLE_MESH_GET_SENSOR_DATA_PROPERTY_ID(_data, _fmt)   \
            (((_fmt) == BFL_BLE_MESH_SENSOR_DATA_FORMAT_A) ? ((((_data)[1]) << 3) | (((_data)[0]) >> 5)) : ((((_data)[2]) << 8) | ((_data)[1])))

/** @def    BFL_BLE_MESH_SENSOR_DATA_FORMAT_A_MPID
 *
 ...
 *
 */
#define BFL_BLE_MESH_SENSOR_DATA_FORMAT_A_MPID(_len, _id) \
        ((((_id) & BIT_MASK(11)) << 5) | (((_len) & BIT_MASK(4)) << 1) | BFL_BLE_MESH_SENSOR_DATA_FORMAT_A)

/** @def    BFL_BLE_MESH_SENSOR_DATA_FORMAT_B_MPID
 *
 ...
 *
 */
#define BFL_BLE_MESH_SENSOR_DATA_FORMAT_B_MPID(_len, _id) \
        (((_id) << 8) | (((_len) & BIT_MASK(7)) << 1) | BFL_BLE_MESH_SENSOR_DATA_FORMAT_B)

/** This enum value is value of Sensor Sampling Function */
enum bfl_ble_mesh_sensor_sample_func {
    BFL_BLE_MESH_SAMPLE_FUNC_UNSPECIFIED,
    BFL_BLE_MESH_SAMPLE_FUNC_INSTANTANEOUS,
    BFL_BLE_MESH_SAMPLE_FUNC_ARITHMETIC_MEAN,
    BFL_BLE_MESH_SAMPLE_FUNC_RMS,
    BFL_BLE_MESH_SAMPLE_FUNC_MAXIMUM,
    BFL_BLE_MESH_SAMPLE_FUNC_MINIMUM,
    BFL_BLE_MESH_SAMPLE_FUNC_ACCUMULATED,
    BFL_BLE_MESH_SAMPLE_FUNC_COUNT,
};
...
} bfl_ble_mesh_sensor_descriptor_t;
...
} bfl_ble_mesh_sensor_series_column_t;
...
typedef struct {
    ...
    bfl_ble_mesh_sensor_descriptor_t descriptor;    /*!< Parameters of the Sensor Descriptor state */
    ...
    bfl_ble_mesh_sensor_setting_t *settings;    /*!< Parameters of the Sensor Setting state */
     ...
     */
    bfl_ble_mesh_sensor_cadence_t *cadence;     /*!< Parameters of the Sensor Cadence state */

    bfl_ble_mesh_sensor_data_t sensor_data;     /*!< Parameters of the Sensor Data state */

    bfl_ble_mesh_sensor_series_column_t series_column;  /*!< Parameters of the Sensor Series Column state */
} bfl_ble_mesh_sensor_state_t;

/** User data of Sensor Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                /*!< Pointer to the Sensor Server Model. Initialized internally. */
    ...
    bfl_ble_mesh_sensor_state_t *states;        /*!< Parameters of the Sensor states */
} bfl_ble_mesh_sensor_srv_t;

/** User data of Sensor Setup Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                /*!< Pointer to the Sensor Setup Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    const uint8_t state_count;                  /*!< Sensor state count */
    bfl_ble_mesh_sensor_state_t *states;        /*!< Parameters of the Sensor states */
} bfl_ble_mesh_sensor_setup_srv_t;
...
} bfl_ble_mesh_state_change_sensor_cadence_set_t;
...
} bfl_ble_mesh_state_change_sensor_setting_set_t;
...
typedef union {
     ...
     */
    bfl_ble_mesh_state_change_sensor_cadence_set_t sensor_cadence_set;  /*!< Sensor Cadence Set */
    bfl_ble_mesh_state_change_sensor_setting_set_t sensor_setting_set;  /*!< Sensor Setting Set */
} bfl_ble_mesh_sensor_server_state_change_t;

/** Context of the received Sensor Descriptor Get message */
typedef struct {
    bool  op_en;    /*!< Indicate if optional parameters are included */
    uint16_t property_id;   /*!< Property ID of a sensor (optional) */
} bfl_ble_mesh_server_recv_sensor_descriptor_get_t;

/** Context of the received Sensor Cadence Get message */
typedef struct {
    uint16_t property_id;   /*!< Property ID of a sensor */
} bfl_ble_mesh_server_recv_sensor_cadence_get_t;

/** Context of the received Sensor Settings Get message */
typedef struct {
    uint16_t property_id;   /*!< Property ID of a sensor */
} bfl_ble_mesh_server_recv_sensor_settings_get_t;
...
} bfl_ble_mesh_server_recv_sensor_setting_get_t;

/** Context of the received Sensor Get message */
typedef struct {
    bool     op_en;         /*!< Indicate if optional parameters are included  */
    uint16_t property_id;   /*!< Property ID for the sensor (optional) */
} bfl_ble_mesh_server_recv_sensor_get_t;

/** Context of the received Sensor Column Get message */
typedef struct {
    uint16_t property_id;   /*!< Property identifying a sensor */
    struct net_buf_simple *raw_value_x; /*!< Raw value identifying a column */
} bfl_ble_mesh_server_recv_sensor_column_get_t;
...
} bfl_ble_mesh_server_recv_sensor_series_get_t;

/**
 * @brief Sensor Server Model received get message union
 */
typedef union {
    bfl_ble_mesh_server_recv_sensor_descriptor_get_t sensor_descriptor; /*!< Sensor Descriptor Get */
    bfl_ble_mesh_server_recv_sensor_cadence_get_t    sensor_cadence;    /*!< Sensor Cadence Get */
    bfl_ble_mesh_server_recv_sensor_settings_get_t   sensor_settings;   /*!< Sensor Settings Get */
    bfl_ble_mesh_server_recv_sensor_setting_get_t    sensor_setting;    /*!< Sensor Setting Get */
    bfl_ble_mesh_server_recv_sensor_get_t            sensor_data;       /*!< Sensor Get */
    bfl_ble_mesh_server_recv_sensor_column_get_t     sensor_column;     /*!< Sensor Column Get */
    bfl_ble_mesh_server_recv_sensor_series_get_t     sensor_series;     /*!< Sensor Series Get */
} bfl_ble_mesh_sensor_server_recv_get_msg_t;

/** Context of the received Sensor Cadence Set message */
typedef struct {
    uint16_t property_id;           /*!< Property ID for the sensor */
    struct net_buf_simple *cadence; /*!< Value of Sensor Cadence state */
} bfl_ble_mesh_server_recv_sensor_cadence_set_t;
...
} bfl_ble_mesh_server_recv_sensor_setting_set_t;

/**
 * @brief Sensor Server Model received set message union
 */
typedef union {
    bfl_ble_mesh_server_recv_sensor_cadence_set_t sensor_cadence;   /*!< Sensor Cadence Set */
    bfl_ble_mesh_server_recv_sensor_setting_set_t sensor_setting;   /*!< Sensor Setting Set */
} bfl_ble_mesh_sensor_server_recv_set_msg_t;

/**
 * @brief Sensor Server Model callback value union
 */
typedef union {
    bfl_ble_mesh_sensor_server_state_change_t state_change; /*!< BFL_BLE_MESH_SENSOR_SERVER_STATE_CHANGE_EVT */
    bfl_ble_mesh_sensor_server_recv_get_msg_t get;  /*!< BFL_BLE_MESH_SENSOR_SERVER_RECV_GET_MSG_EVT */
    bfl_ble_mesh_sensor_server_recv_set_msg_t set;  /*!< BFL_BLE_MESH_SENSOR_SERVER_RECV_SET_MSG_EVT */
} bfl_ble_mesh_sensor_server_cb_value_t;

/** Sensor Server Model callback parameters */
typedef struct {
    bfl_ble_mesh_model_t  *model;   /*!< Pointer to Sensor Server Models */
    bfl_ble_mesh_msg_ctx_t ctx;     /*!< Context of the received messages */
    bfl_ble_mesh_sensor_server_cb_value_t value;    /*!< Value of the received Sensor Messages */
} bfl_ble_mesh_sensor_server_cb_param_t;
...
typedef enum {
     ...
     *    are received.
     */
    BFL_BLE_MESH_SENSOR_SERVER_STATE_CHANGE_EVT,
    /**
     * When get_auto_rsp is set to BFL_BLE_MESH_SERVER_RSP_BY_APP, this event will be
     * callback to the application layer when Sensor Get messages are received.
     */
    BFL_BLE_MESH_SENSOR_SERVER_RECV_GET_MSG_EVT,
    /**
     ...
     */
    BFL_BLE_MESH_SENSOR_SERVER_RECV_SET_MSG_EVT,
    BFL_BLE_MESH_SENSOR_SERVER_EVT_MAX,
} bfl_ble_mesh_sensor_server_cb_event_t;
 ...
 * @param   param: Pointer to callback parameter
 */
typedef void (* bfl_ble_mesh_sensor_server_cb_t)(bfl_ble_mesh_sensor_server_cb_event_t event,
        bfl_ble_mesh_sensor_server_cb_param_t *param);
 ...
 *
 */
bfl_err_t bfl_ble_mesh_register_sensor_server_callback(bfl_ble_mesh_sensor_server_cb_t callback);

#ifdef __cplusplus
}
#endif

#endif /* _BFL_BLE_MESH_SENSOR_MODEL_API_H_ */
