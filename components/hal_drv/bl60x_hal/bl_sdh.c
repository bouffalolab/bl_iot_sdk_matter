...
#define SDH_CLK_PIN                     GLB_GPIO_PIN_16
#define SDH_CMD_PIN                     GLB_GPIO_PIN_17
#define SDH_DAT0_PIN                    GLB_GPIO_PIN_18
#define SDH_DAT1_PIN                    GLB_GPIO_PIN_19
#define SDH_DAT2_PIN                    GLB_GPIO_PIN_20
#define SDH_DAT3_PIN                    GLB_GPIO_PIN_21

#define SDH_CLK_PIN_FUN                 GPIO16_FUN_SDH_CLK
#define SDH_CMD_PIN_FUN                 GPIO17_FUN_SDH_CMD
#define SDH_DAT0_PIN_FUN                GPIO18_FUN_SDH_DAT0
#define SDH_DAT1_PIN_FUN                GPIO19_FUN_SDH_DAT1
#define SDH_DAT2_PIN_FUN                GPIO20_FUN_SDH_DAT2
#define SDH_DAT3_PIN_FUN                GPIO21_FUN_SDH_DAT3

#define SDH_SDCARD_IRQn                 SDH_MMC1_IRQn
#define SDH_SDCARD_IRQ_PRIORITY_PRE     (7)
...
static SD_Error SDH_CMDWaitStatus   =  SD_WAITING;
...
static SDH_ADMA2_Desc_Type adma2Entries[16] __OCRAM;
...
status_t SD_SelectFunction(uint32_t group, uint32_t function);
...
void SD_NVIC_SetPriority(void)
{
    uint32_t prioritygroup = 0x00;

    prioritygroup = NVIC_GetPriorityGrouping();

    NVIC_SetPriority(SDH_SDCARD_IRQn, NVIC_EncodePriority(prioritygroup, SDH_SDCARD_IRQ_PRIORITY_PRE, SDH_SDCARD_IRQ_PRIORITY_SUB));
}
...
static void SDH_INT_Init(void)
{
    NVIC_EnableIRQ(SDH_SDCARD_IRQn);
    SD_NVIC_SetPriority();
...
status_t SDH_Init(uint32_t bus_wide,sd_card_t* pOutCardInfo)
{
    ...
    errorstatus = SDH_SDCardInit(bus_wide,pOutCardInfo);
