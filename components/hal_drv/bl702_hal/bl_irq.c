 ...
 * 
 * */
//void intc_irq(void)         __attribute__((weak, alias ("bl_irq_default")));
void rwble_isr(void)                 __attribute__((weak, alias ("bl_irq_default")));
void macphy154_test_isr(void)        __attribute__((weak, alias ("bl_irq_default")));
void phy_isr(void)        __attribute__((weak, alias ("bl_irq_default")));
